function createV4SelectableForceDirectedGraph(svg, graph) {
  ...
  function getGradID(d) {
    return "linkGrad-" + d.source + "-" + d.target;
  }
  ...
  lingrads.attr("id", getGradID).attr("gradientUnits", "userSpaceOnUse");
  //source = red
  ...
  var node = gDraw
    ...
    .attr("fill", function (d) {
      ...
      else if (d.group == 1) return "#626262";
